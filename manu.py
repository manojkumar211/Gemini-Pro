...
def process_uploaded_file(upload_file):
    ...
    if upload_file.name.endswith('.xlsx'):
        ...
        json_file_path = "C:/Projects/astria/xlsx_json.json"  # Specify the correct file path and extension
        ...
        # Write the data to a JSON file
        json_file_path = "C:/Projects/astria/docx_json.json"
        with open(json_file_path, 'w') as json_file:
            json.dump(data, json_file, indent=4)
        ...
        for page in pdf_reader.pages:
            ...
            json_file_path = "C:/Projects/astria/pdf_json.json"  # Specify the correct file path and extension
