...
def process_uploaded_file(upload_file):
    if upload_file.name.endswith('.xlsx'):
        ...
        json_file_path = "C:/Projects/astria/files/xlsx_json.json"
        ...
        # Write the data to a JSON file
        json_filedocx_path = "C:/Projects/astria/files/docx_json.json"  # Specify the correct JSON file path
        with open(json_filedocx_path, 'w', encoding='utf-8') as json_file:
            json.dump(data, json_file, indent=4)

        print(f"Data extracted and saved to {json_filedocx_path}")
        ...
        # Write the data to a JSON file
        json_filepdf_path = "C:/Projects/astria/files/pdf_json.json"  # Specify the correct JSON file path
